      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="inline-flex items-center px-4 py-2 bg-primary-100 rounded-full mb-6 text-primary-700">
          ...
          <p className="text-xl text-secondary-600 max-w-3xl mx-auto">
            ...
            Smarter discovery, clearer analytics, better context. SmartTagX AI can be used universally across all platforms.
          </p>
        </div>
        ...
        <div className="bg-slate-50 rounded-3xl p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <h4 className="text-xl font-semibold text-secondary-900 mb-4">AI Analysis</h4>
              <p className="text-secondary-600">
                Our NLP models find topics, entities, locations, and relationships to understand meaning.
              </p>
            </div>
            <div className="text-center">
          ...
          <div className="mt-12 bg-white border border-slate-200 rounded-2xl p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h4 className="text-lg font-semibold text-secondary-900">Minimal data by default</h4>
            </div>
            <p className="text-secondary-600">
              We keep it simple: basic account details, your total tag count, and your current plan. Nothing extra.
            </p>
          </div>
        </div>
      </div>
